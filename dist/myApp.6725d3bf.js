...
var MyList = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(MyList, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n            <h1 class=\"awesomeTitle\">", "</h1>\n            ", "\n        "])), this.title, this.items.length > 0 ? (0, _litElement.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n            <ul class=\"awesomeList\">\n                ", "\n            </ul>\n            "])), this.items.map(function (item) {
        return (0, _litElement.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["<li class=\"awesomeElement\">", "(", ")</li>"])), item.name, item.year);
      })) : (0, _litElement.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["<h1 class=\"awesomeMessage\">No hay datos</h1>"]))));
    }
  }], [{
    key: "properties",
    get: function get() {
    ...
    key: "styles",
    get: function get() {
      return (0, _litElement.css)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n            .awesomeTitle{\n                font-size: 40px;\n                color: #BF930D;\n                text-transform: uppercase;\n                font-family: sans-serif;\n            }\n            .awesomeList{\n                list-style: upper-alpha;\n                font-size: 20px;\n                color: #BF930D;\n                font-family: sans-serif;\n            }\n            .awesomeMessage{\n                font-size: 30px;\n                font-weight:normal;\n                color: #BF930D;\n                font-family: sans-serif;\n            }\n        "])));
    }
  }]);
...
var MyApp = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(MyApp, [{
    ...
    key: "render",
    value: function render() {
      return (0, _litElement.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n        <button class=\"awesomeBtn\" @click=\"", "\">Vaciar lista</button>\n        <button class=\"awesomeBtn\" @click=\"", "\">Crear lista</button>\n        <my-list title=\"My favorite movies\" .items=", "></my-list> \n        "])), this._onEmptyList, this._onCreateList, this.list);
    }
  }], [{
    key: "properties",
    get: function get() {
